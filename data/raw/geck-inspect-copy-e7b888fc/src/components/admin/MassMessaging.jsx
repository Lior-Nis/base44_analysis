...
import { 
    Send, Users, Shield, Award, Loader2, Sparkles, 
    Megaphone, Mail, MessageSquare, Bell
} from 'lucide-react';
import { Select, SelectContent, SelectItem, SelectTrigger, SelectValue } from "@/components/ui/select";
import { sendMassMessage } from '@/api/functions';
import { InvokeLLM } from '@/api/integrations';

const TARGET_GROUPS = [
    { value: 'all', label: 'All Users', icon: <Users className="w-4 h-4" />, color: 'bg-blue-600' },
    ...
    { value: 'non_experts', label: 'Regular Users', icon: <Users className="w-4 h-4" />, color: 'bg-gray-600' },
];
...
export default function MassMessaging() {
    ...
    const handleSend = async () => {
        ...
        try {
            ...
            toast({ 
                title: "Success!", 
                description: `Message sent to ${data.sent_count} users.` 
            });
